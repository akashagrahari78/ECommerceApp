...
const Collection = () => {
  ...
  const toggleCategory = (e) => {
    ...
    if (category.includes(value)) {
      const updatedList = category.filter((item)=> item !== value);
      setCategory(updatedList)
      // setCategory((prev) => prev.filter((item) => item != e.target.value));
    } else {
      const updatedList = [...category, value];
      setCategory(updatedList);
    }
  };
  ...
  const toggleSubCategory = (e)=>{
    ...
    if (subCategory.includes(value)) {
      const updatedList = subCategory.filter((item)=> item !== value);
      setSubCategory(updatedList)
      // setCategory((prev) => prev.filter((item) => item != e.target.value));
    } else {
      const updatedList = [...subCategory, value];
      setSubCategory(updatedList);
    }
  }
  ...
  const applyFilter = ()=>{
    ...
    // for category selection like men , women
  ...
  const sortProduct = ()=>{
    let fpCopy = filterProducts.slice();   //createing copies of already filtered product for a category
